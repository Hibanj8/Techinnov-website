...
const Contact = () => {
  return (
    <>
      <div
        className="relative pb-[110px] pt-[120px] dark:bg-dark lg:pt-[150px] lg:ml-20 ml-0"
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg dark:bg-dark-2 sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded border border-primary bg-[#4C1D41] p-3 text-white transition hover:bg-[#4c1d41d3]"
                    >
                      Send Message
                    </button>
                  </div>
