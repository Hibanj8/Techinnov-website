  ...
  return (
    ...
    >
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              <span className=" text-white mb-2 block text-lg font-semibold text-primary">
                Our Services
              </span>
              ...
              <p className="text-base text-body-color text-white">
                Explore our cutting-edge technology services designed
                to meet your most demanding needs.
                From design to implementation,
                we offer a comprehensive range of services to propel
        ...
        <div className="-mx-4 flex flex-wrap">
          <ServiceCard
            title="Exceptional Design Solutions"
            details="We take pride in crafting designs that resonate with our clients' unique vision. Our commitment to quality, exemplary service, integrity, and aesthetic excellence sets us apart."
            icon={
              <svg
                width="36"
                height="36"
          ...
          />
          <ServiceCard
            title="Tailored Styling with Tailwind CSS"
            details="Our designs are not just visually appealing but also built on the robust foundation of Tailwind CSS.This ensures a seamless and modern user experience that aligns with your brand identity."
            icon={
              <svg
                width="36"
                height="36"
          ...
          />
          <ServiceCard
            title="Diverse Range of Components"
            details="Explore our extensive library of over 100 components designed to enhance the functionality and visual appeal of your project. Each component is carefully crafted to elevate your website's performance."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            ...
            details="Speed matters, and our services are geared towards delivering optimized solutions. Experience swift loading times and seamless navigation, providing an exceptional user experience for your audience."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            ...
            details="We understand the importance of uniqueness. Our services are fully customizable,
             allowing you to tailor every aspect of your project to suit your specific needs and preferences."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            ...
            details="In the dynamic digital landscape, staying current is crucial. 
            We are dedicated to providing regular updates to keep your project aligned with the latest trends,
  ...
  return (
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-[20px] bg-white h-[390px] p-10 duration-300 hover:shadow-lg hover:shadow-[#f18cd9dc] z-index-10">
          <div className="mb-8 flex h-[70px] w-[70px] bg-[#4C1D41] items-center justify-center rounded-2xl bg-primary">
            {icon}
          </div>
